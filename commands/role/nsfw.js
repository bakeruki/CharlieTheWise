        ...
        collector.on('collect', async i => {
            ...
            if(i.customId === 'yes'){
                ...
                if(i.member.roles.cache.has(accessRole)){
                    ...
                    i.reply({content: `The role ${role} was successfully added! God help you... (if you clicked this by mistake, please run the command again and select No)`, ephemeral: true })
                    collector.stop('done')
                }
                ...
                if(i.member.roles.cache.has(accessRole)){
                    ...
                    i.reply({content: `You've been saved...`, ephemeral: true })
                    collector.stop('done')
                }else{
                    i.reply({content: `You don't have access!`, ephemeral: true })
                    collector.stop('done')
                }
            }
        })
